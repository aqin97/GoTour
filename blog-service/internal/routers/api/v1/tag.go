...
import (
	...
	"github.com/aqin97/GoTour/blog-service/internal/service"
...
func (t Tag) List(c *gin.Context) {
	...
	totalRows, err := svc.CountTag(&service.CountTagRequset{Name: param.Name, State: param.State})
	if err != nil {
...
func (t Tag) Delete(c *gin.Context) {
	param := service.DeleteTagRequset{
		ID: convert.StrTo(c.Param("id")).MustUint32(),
	}
	response := app.NewResponse(c)
	valid, errs := app.BindAndValid(c, &param)
